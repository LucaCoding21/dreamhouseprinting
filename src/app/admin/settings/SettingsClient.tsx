...
function DecorationMethodsTab({ methods }: { methods: DecorationMethodRow[] }) {
  if (methods.length === 0) {
    return <EmptyState title="No decoration methods" description="Decoration methods are the techniques you offer, like screen print and embroidery. Their pricing lives on the Pricing page." />;
  }
  return (
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-3">
        ...
        {/* No money fields here. These once fed a cost-plus estimate that no
            longer exists; all pricing now lives on the Pricing page. */}
